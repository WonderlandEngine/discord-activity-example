...
6. [Publish the Wonderland project as a Wonderland Cloud Page](https://github.com/WonderlandEngine/wonderland-cloud/blob/main/cli/README.md#publish-mode) via `npm run create-activity-page` this will publish your Discord activity to the web
